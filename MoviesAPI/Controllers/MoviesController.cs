...
namespace MoviesAPI.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public async Task<ActionResult<MoviePutGetDTO>> PutGet(int id)
        {
            ...
            var genresSelectedIds = movie.Genre.Select(x => x.Id).ToList();
            var nonSelectedGenres = await context.Genres.Where(x => !genresSelectedIds.Contains(x.Id))
                .ToListAsync();

            var movieTheatersIds = movie.MoviesTheater.Select(x => x.Id).ToList();
            ...
            response.SelectedGenres = movie.Genre;
            response.NonSelectedGenres = nonSelectedGenresDTOs;
            response.SelectedMovieTheaters = movie.MoviesTheater;
